...
public class TCPServer {
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        /* Creating each object for each "TCPServer
        " class to call
         * createSocket and sendFile methods.    */
        TCPServer fileServer1 = new TCPServer();
        TCPServer fileServer2 = new TCPServer();
        TCPServer fileServer3 = new TCPServer();
        TCPServer fileServer4 = new TCPServer();
        TCPServer fileServer5 = new TCPServer();
