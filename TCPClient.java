...
public class TCPClient implements Runnable
{
    ...
    public TCPClient(Socket socket2) {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        /* Creating five objects of TCPClient to create each threads.*/
        TCPClient fileClient1 = new TCPClient(socket1);
        TCPClient fileClient2 = new TCPClient(socket2);
        TCPClient fileClient3 = new TCPClient(socket3);
        TCPClient fileClient4 = new TCPClient(socket4);
        TCPClient fileClient5 = new TCPClient(socket5);

        /*Creating five anonymous threads and calling the methods */
        Thread t1 = new Thread(new TCPClient(socket1))
        {
            public void run()
            {
        ...
        Thread t2 = new Thread(new TCPClient(socket2))
        {
            public void run()
            {
        ...
        Thread t3 = new Thread(new TCPClient(socket3))
        {
            public void run()
            {
        ...
        Thread t4 = new Thread(new TCPClient(socket4))
        {
            public void run()
            {
        ...
        Thread t5 = new Thread(new TCPClient(socket5))
        {
            public void run()
            {
